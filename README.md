...
* **Goals:**
  ...
  * Import the 6-month real estate dataset into a Jupyter Notebook via pandas.


  * Map out and analyze distributions for the five core metrics: `ClosePrice`, `LivingArea`, `Bedrooms`, `Bathrooms`, and `LotSize`.


  * Filter the scope strictly to `PropertyType = "Residential"` and `PropertySubType = "Single Family Residence"` rows.
